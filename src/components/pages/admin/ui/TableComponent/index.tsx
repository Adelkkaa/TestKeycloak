...
import { TPreferAdminData } from '../../types';
...
type TableProps = {
  ...
  preferedAdminData?: TPreferAdminData;
};

export const Table: FC<TableProps> = ({ selectedFilters, preferedAdminData }) => {
  const filterTableData = preferedAdminData?.List.filter((v) =>
